...
import { verifyPassword } from '~/auth/password-hashing.server'
import { type Customer, Email } from '~/auth/schemas.server'
...
export async function action({ request }: Route.ActionArgs) {
  ...
  const isPasswordValid = await verifyPassword(passwordHashRow.hash, _password)
...
export default function Login({ actionData }: Route.ComponentProps) {
  ...
  return (
    <div>
      <title>Login | Football Ticketing Web App</title>
      <meta property="og:title" content="Login | Football Ticketing Web App" />
      <meta
        name="description"
        content="Login to your account to manage your football tickets"
      />
